...
```bash
git clone https://github.com/fastcam-sideproject/master-plan-b.git
```
    ...
    <tr>
     <td align="center" valign="middle">
      ...
      <td align="center" valign="middle">
        <div>
          <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/1x1.png" width="500" height="1" />
          <img width="50" src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Tailwind_CSS_Logo.svg" />
          <p align="center">
            TailwindCSS
          </P>
        </div>
      ...
      <td align="center" valign="middle">
        <div>
          <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/1x1.png" width="500" height="1" />
          <img width="70" src="https://axios-http.com/assets/logo.svg" />
          <p align="center">
            Axios
          </p>
        </div>
        ...
        <div>
          <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/1x1.png" width="500" height="1" />
          <img width="50" src="https://cdn.candycode.com/jotai/jotai-mascot.png" />
          <p align="center">
            Jotai
          </p>
        </div>
...
### [Master-Plan-B 프로젝트 컨벤션 정리](https://github.com/fastcam-sideproject/master-plan-b/wiki/%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-%EC%BB%A8%EB%B2%A4%EC%85%98)
...
Master-Plan-B을 구현하면서 고민했던 내용들을 볼 수 있습니다.
