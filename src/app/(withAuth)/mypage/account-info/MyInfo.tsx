            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex gap-4">
                <Image
                  src={
                    accountStatus.naver
                      ? AccountLogoImages.NaverOn
                      : AccountLogoImages.NaverOff
                  }
                  alt="네이버 계정"
                  width={50}
                  height={50}
                ...
                <Image
                  src={
                    accountStatus.kakao
                      ? AccountLogoImages.KakaoOn
                      : AccountLogoImages.KakaoOff
                  }
                  alt="카카오 계정"
                  width={50}
                  height={50}
                ...
                <Image
                  src={
                    accountStatus.google
                      ? AccountLogoImages.GoogleOn
                      : AccountLogoImages.GoogleOff
                  }
                  alt="구글 계정"
                  width={50}
                  height={50}
        ...
        <div className="flex flex-col gap-4">
          <ul className="flex items-center justify-between">
            ...
            >
              <IconPlus
                size={20}
                className="!h-[20px] !w-[20px] text-blue-40"
              />
              <p>추가하기</p>
            </Button>
          </ul>
