  ...
  return (
    <div className="relative flex h-[276px] rounded-6 bg-neutral-85 px-7 py-9">
      ...
      <div className="flex w-full flex-col gap-9">
        <div>
          <div className="text-body-small-desktop text-neutral-0">
            국가기술자격
          </div>
          ...
          <ul className="flex gap-5">
            <li className="text-body-large-desktop font-[900] text-neutral-50">
              시험일
            </li>
            <li className="text-body-large-desktop text-neutral-0">
              2025년 1월 10일 (월)
            </li>
