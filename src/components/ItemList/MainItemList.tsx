...
export function MainItemList({ title, labels, tags, content }: MainItemListProps) {
  ...
  return (
    <div className="w-[688px] mobile:w-[335px] px-10 mobile:px-6 py-12 mobile:py-7 bg-neutral-0 rounded-9 mobile:rounded-8 flex-col justify-center items-center inline-flex">
