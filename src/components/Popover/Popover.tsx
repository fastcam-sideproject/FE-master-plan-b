...
const popoverVariants = cva('text-center', {
  variants: {
    ...
    tipDirection: {
      down: 'top-full mt-[6px] after:content-[""] after:absolute after:w-0 after:h-0 after:border-l-[6px] after:border-l-transparent after:border-r-[6px] after:border-r-transparent after:border-b-[6px] after:-top-[6px]',
      up: 'bottom-full mb-[6px] after:content-[""] after:absolute after:w-0 after:h-0 after:border-l-[6px] after:border-l-transparent after:border-r-[6px] after:border-r-transparent after:border-t-[6px] after:-bottom-[6px]',
    },
    tipPosition: {
