...
export type CalendarForDayInputProps = {
  date: Date;
  bg: 'light' | 'dark';
  size: 'large' | 'small';
  className?: string;
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: `size-full flex justify-center items-center ${isDark ? 'text-neutral-0' : 'text-neutral-85'} cursor-pointer`,
...
CalendarForDayInput.displayName = 'CalendarForDayInput';

export { CalendarForDayInput };
