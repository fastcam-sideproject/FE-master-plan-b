...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'p-4 text-left align-middle font-medium [&:has([role=checkbox])]:pr-0 !text-neutral-30 text-body-medium-desktop',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'p-4 font-[400] align-middle [&:has([role=checkbox])]:pr-0 !text-neutral-85 text-body-medium-desktop',
      className,
    )}
    {...props}
  />
